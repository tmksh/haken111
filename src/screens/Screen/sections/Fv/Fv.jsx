...
export const Fv = () => {
  return (
    <div className="absolute top-0 left-px w-[1439px] h-[624px]">
      <img
        className="absolute top-20 left-0 w-[1439px] h-[544px]"
        alt="Image"
        src="/img/image-2.png"
      />

      <img
        className="absolute top-0 left-0 w-[1439px] h-[624px]"
        alt="Image"
        src="/img/image.png"
      />

      <div className="flex flex-col w-[908px] items-start gap-[76px] absolute top-36 left-[116px]">
