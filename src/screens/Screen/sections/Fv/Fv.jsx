...
export const Fv = () => {
  ...
  return (
    <>
      ...
      <div className="bg-[#ffffff] overflow-hidden w-full relative pt-4 md:hidden flex justify-start" style={{ height: `${16 + (119 + 168.46 + 53.2 + 235.26) * mobileScale + 160}px` }}>
        <div 
          style={{
            width: '643px',
            height: '846px',
      ...
      <div className="bg-[#ffffff] overflow-hidden w-full relative pt-20 hidden md:block lg:hidden flex justify-start" style={{ minHeight: `${1378 * tabletScale}px` }}>
        <div 
          style={{
            width: '1048px',
            height: '1378px',
