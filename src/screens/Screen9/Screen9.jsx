...
export const Screen9 = () => {
  ...
  return (
    ...
    className= "bg-grey1-bg w-full min-w-[1440px] min-h-[5860px] relative" 
...
<div
    ...
    className= "flex flex-col w-[302px] items-start gap-8 absolute top-[377px] left-[1098px]" 
...
<div
    ...
    className= "bg-white border border-solid border-blue flex w-[254px] h-[50px] items-center gap-1 p-3.5 relative rounded-lg" 
