...
export const StepSmall = ({
  ...
  return (
    <div
      className={`flex flex-col w-[110px] md:w-[134px] h-auto md:h-28 items-center gap-1.5 md:gap-2 px-3 md:px-4 py-2.5 md:py-3.5 relative bg-blue rounded-[14px] flex-shrink-0 ${className}`}
    >
