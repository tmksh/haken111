...
export const Company = ({
  ...
  return (
    <div
      className={`flex flex-col w-full h-[66px] items-center justify-center gap-2.5 px-2 md:px-[42px] py-4 relative bg-white rounded-lg border border-solid border-grey-3 ${className}`}
    >
      <div className="flex flex-col w-full max-w-[98px] items-center gap-1.5 relative flex-[0_0_auto]">
