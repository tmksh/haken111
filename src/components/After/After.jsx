...
export const After = ({ className }) => {
  return (
    <div
      className={`relative top-[3274px] left-[734px] w-[185px] h-20 bg-[url(/img/union-2.svg)] bg-[100%_100%] ${className}`}
    >
      <div className="flex flex-col w-[84.86%] items-start gap-1.5 relative h-[76.25%] top-[12.50%] left-[10.81%]">
        <div className="flex flex-col items-start gap-0.5 relative self-stretch w-full flex-[0_0_auto]">
          ...
          <div className="self-stretch text-text text-[13px] leading-[13px] relative [font-family:'Noto_Sans_JP',Helvetica] font-medium text-center tracking-[0]">
            大規模倉庫
          </div>
        </div>

        <div className="relative self-stretch [font-family:'Noto_Sans_JP',Helvetica] font-bold text-blue text-xl text-center tracking-[0] leading-5">
          年収580万円
        </div>
      </div>
    </div>
